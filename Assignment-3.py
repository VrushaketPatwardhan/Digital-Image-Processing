import cv2
original = cv2.imread('vrushaket.jpeg')
original_red = cv2.imread('vrushaket.jpeg')
original_green = cv2.imread('vrushaket.jpeg')
original_blue = cv2.imread('vrushaket.jpeg')
